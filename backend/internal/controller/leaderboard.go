...
func GetHostelLeaderboard(c *gin.Context) {
	...
	G1 := (1.0/3000)/((1.0/3000) + (1.0/150) + (1.0/200000) + (1.0/500) + (1.0/250))
	G2 := (1.0/500)/((1.0/3000) + (1.0/150) + (1.0/200000) + (1.0/500) + (1.0/250))
	G3 := (1.0/250)/((1.0/3000) + (1.0/150) + (1.0/200000) + (1.0/500) + (1.0/250))
	G4 := (1.0/150)/((1.0/3000) + (1.0/150) + (1.0/200000) + (1.0/500) + (1.0/250))
	G5 := (1.0/200000)/((1.0/3000) + (1.0/150) + (1.0/200000) + (1.0/500) + (1.0/250))
