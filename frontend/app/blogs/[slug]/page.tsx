...
// --- Main Blog Page ---
export default async function BlogPage({ params }: { params: { slug: string } }) {  // Next.js may provide params values as promises in some environments — await them before use
  const { slug } = params;
